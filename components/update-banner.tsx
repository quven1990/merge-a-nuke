...
const UPDATE_DATE = "July 18, 2026"
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 text-sm leading-relaxed text-muted-foreground">
              Contract Board, Volcano Admin Abuse, Town Square, Diplomat, Welder, and Forklift
              Operator — plus Disco rework and held-nuke damage changes.
            </p>
          </div>
        </div>
        <TrackedCtaLink
          href="/updates"
          label="Whats New July 18 Contract Volcano"
